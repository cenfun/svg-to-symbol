...
const injectIcons = (metadata, retry = 0) => {
    ...
    div.innerHTML = metadata.svgSymbolContent;
...
const init = function(metadata) {
    ...
    metadata.containerId = `svg-symbol-${metadata.prefix}-container`;
    metadata.svgSymbolContent = getSvgSymbolContent(metadata);
